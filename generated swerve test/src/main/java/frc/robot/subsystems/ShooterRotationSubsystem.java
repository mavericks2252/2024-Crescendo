...
public class ShooterRotationSubsystem extends SubsystemBase {
  ...
  public ShooterRotationSubsystem(VisionPhotonSubsystem photon) {
    ...
    TalonFXConfiguration shooterAngleConfig = new TalonFXConfiguration();
            ...
            shooterAngleConfig.SoftwareLimitSwitch.ForwardSoftLimitThreshold=degreesToMotorRevs(ShooterConstants.kForwardSoftLimit);
            shooterAngleConfig.SoftwareLimitSwitch.ReverseSoftLimitThreshold=degreesToMotorRevs(ShooterConstants.kReverseSoftLimit);
  ...
  public double motorRevsToDegrees(double revs){
    return revs/ShooterConstants.kShooterGearBoxRatio*360;
  }

  public double degreesToMotorRevs(double degrees){
    return degrees/360*ShooterConstants.kShooterGearBoxRatio;
  }
